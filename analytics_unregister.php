...
<head>
    ...
    <style>
        ...
        /* --- Nav Login Button (yellow, auto width) --- */
        .login-btn-nav {
...
<body>
    ...
    <script>
        ...
        new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Weather Trends', 'UrbanRelocation', 'Economic Factors','Health & Wellness Trends' ],
                datasets: [{
                    label: 'Adoption Frequency',
                    data: [78, 45, 60, 85],
                    backgroundColor: ['#4A90E2', '#F5A623', '#50E3C2', '#2ECC71'],
                    borderRadius: 8,
                    barThickness: 60,
                    borderColor: '#2c2c2c',
                    borderWidth: 0.5
