...
function mapStatus(array $row): string
{
    ...
    if (!empty($row['InboxStatus'])) {
        switch ($row['InboxStatus']) {
            ...
            case 'Resolved':    return 'resolved';
            case 'In Progress': return 'reviewing';
            case 'Pending':     return 'pending';
        }
    }
    return 'pending';
...
<body>
    ...
    <div class="modal-overlay" id="delete-modal">
        <div class="modal">
            ...
            <p class="modal-body">Are you sure you want to delete the report by <strong id="delete-name"></strong>? This action cannot be undone.</p>
