<?php
    // Start session and retrieve admin name
    session_start();
    ...
    $adopt_count = $conn->query(
        "SELECT COUNT(*) as total FROM adopt_application"
    )->fetch_assoc()['total'];

    /*  LATEST RECORDS FOR DASHBOARD PREVIEW */

    // Most recently registered resident
    $new_resident = $conn->query(
    ...
    // Latest pet report submitted
    $new_report = $conn->query(
        "SELECT PetName
         FROM report
    ...
    // Latest guideline added
    $new_guide = $conn->query(
        "SELECT Title
         FROM guidelines
         ORDER BY GuidelineID DESC
         LIMIT 1"
    )->fetch_assoc();
...
<body>
        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card">
                ...
                <p>
                    <?php
                    echo $new_resident
                        ? htmlspecialchars($new_resident['FirstName'] . ' ' . $new_resident['LastName'])
                        : 'No data';
                    ?>
                </p>
                <a href="usercount.php" class="dashboard-btn btn-resident">
                    View Residents
                </a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <a href="usercount.php?tab=ngo" class="dashboard-btn btn-ngo">
                    View NGOs
                </a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <a href="Add_Report.php" class="dashboard-btn btn-report">
                    View Reports
                </a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <a href="pet_communityadmin.php" class="dashboard-btn btn-community">
                    View Posts
                </a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <a href="help_center.php?tab=guidelines" class="dashboard-btn btn-guideline">
                    View Guidelines
                </a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <a href="help_center.php?tab=faq" class="dashboard-btn btn-help">
                    View Help Articles
                </a>
            </div>
    ...
    <footer>
        ...
        <div class="footer-grid">
            ...
            <div>
                ...
                <p class="footer-tagline">
                    A compassionate digital hub for stray pet adoption
                    and community care in Bandar Klang, Selangor.
                </p>
            </div>
        ...
        <div class="footer-bottom">
            <span>
                © 2026 Furever Pet Home — Urban Pet Adoption & Community Management
            </span>
            <span>
                Made with ❤️ for Bandar Klang
            </span>
        </div>
