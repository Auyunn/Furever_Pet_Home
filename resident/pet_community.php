    ...
    <div class="wrapper">
        ...
        <?php if (mysqli_num_rows($result_board) > 0): ?>
            <?php while ($post = mysqli_fetch_assoc($result_board)): ?>
                ...
                <div class="box">
                    <img src="../image/pet_community/<?php echo htmlspecialchars($post['Photo']); ?>" alt="Pet Community Image"
                        class="img">
                    ...
                    <div class="content">
                        ...
                        <div class="panel" id="panel-<?php echo $board_id; ?>">
                            ...
                            <form action="pet_community.php" method="POST" class="comment-input-row">
                                ...
                                <input type="text" name="content" class="comment-input" placeholder="Write your comment"
                                    required>
