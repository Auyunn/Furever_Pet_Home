...
/** Folder where report photos live — adjust to match your uploads path */
const REPORT_PHOTO_DIR = 'images/reports/';
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="navbar-top">
                    ...
                    <div class="nav-right">
                        <button class="notif-btn" title="Notifications"
                            onclick="window.location.href='resident/inbox.php';">🔔<span
